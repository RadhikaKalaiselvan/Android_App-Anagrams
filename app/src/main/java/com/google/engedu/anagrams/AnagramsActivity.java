...
public class AnagramsActivity extends AppCompatActivity {
    ...
    public static final String TAG=AnagramsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                Log.d("Listener set",actionId+" "+EditorInfo.IME_ACTION_GO);
                if (actionId == EditorInfo.IME_ACTION_GO) {
                    Log.d(" inside if",editText.getText().toString());
